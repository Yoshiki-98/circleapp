    ...
    <div class="container">
        ...
        <form action="/board/add" method="post">
            ...
            <div class="a_form">
                ...
                @endif
                <input type="text" name="univ" class="circle-info" autocomplete="off" placeholder="大学名" list="univ" value="{{old('univ')}}">
                <datalist id="univ">
                <option value="京都大学">
                <option value="京都教育大学">
            ...
            <div class="a_form">
                ...
                @endif
                <input type="text" name="circle" class="circle-info" autocomplete="off" placeholder="サークル" value="{{old('circle')}}">
            </div>
            <div class="a_form">
                ...
                @endif
                <input type="text" name="sports" class="circle-info" autocomplete="off" placeholder="競技名" list="sports" value="{{old('sports')}}">
                <datalist id="sports">
                <option value="野球">
                <option value="サッカー">
                <option value="バレーボール">
            ...
            <div class="a_form">
                ...
                @endif
                <input type="text" name="area" class="circle-info"　autocomplete="off" placeholder="活動地域" list="kyoto" value="{{old('area')}}">
                <datalist id="kyoto">
                <option value="左京区">
                <option value="右京区">
                <option value="上京区">
            ...
            <div class="a_form">
                ...
                <input type="text" name="url" class="circle-info"　autocomplete="off" placeholder="URL" value="{{old('url')}}">
            </div>
